/*
  This program is commented in Portuguese and English

  Portuguese: 
    Monitoramento da velocidade em RPM de um ventilador utilizando em cooler de CPU
...
// Portuguese: Pino que sera conectado a fio de sinal do ventilador (em geral amarelo)
...
// Portuguese: fan_hall_sensor indica o comportamento do sensor do ventilador utilizado. 
//             Voce deve verificar essa informacao na descricao do fabricante do cooler e ajustar o valor desta variavel. 
// English...: fan_hall_sensor tell to the system how many pulses are generated by turns.
...
void setup()
{
  ...
  Serial.begin(9600);
  // Portuguese: Conecta a funcao countTurns a interrupcao 0
